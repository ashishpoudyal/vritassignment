...
//
//     final shortenUrlModel = shortenUrlModelFromJson(jsonString);

import 'dart:convert';

ShortenUrlModel shortenUrlModelFromJson(String str) => ShortenUrlModel.fromJson(json.decode(str));

String shortenUrlModelToJson(ShortenUrlModel data) => json.encode(data.toJson());
...
class ShortenUrlModel {
    ...
    factory ShortenUrlModel.fromJson(Map<String, dynamic> json) => ShortenUrlModel(
        id: json["id"],
        title: json["title"],
